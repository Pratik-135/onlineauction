													...
													<div class="first-row form-group">
														<div class="w3_agileits_card_number_grid_right">
															...
															<div class="w3_agileits_card_number_grid_left">
																<div class="controls">
																	<label class="control-label">Deposit amount <span
																			class="errormsg"
																			id="errpaid_amount"></span></label>
																	<input name="paid_amount" id="paid_amount"
																		class="form-control" type="text"
																		placeholder="Deposit amount"
																		value="<?php echo $rsedit['paid_amount']; ?>">
																</div>
															</div>
															...
															<div class="w3_agileits_card_number_grid_left">
																<div class="controls">
																	<label class="control-label">Card holder <span
																			class="errormsg"
																			id="errcard_holder"></span></label>
																	<input name="card_holder" id="card_holder"
																		class="form-control" placeholder="card holder"
																		value="<?php echo $rsedit['card_holder']; ?>">
																</div>
															</div>
															...
															<div class="w3_agileits_card_number_grid_left">
																<div class="controls">
																	<label class="control-label">Card number <span
																			class="errormsg"
																			id="errcard_number"></span></label>
																	<input name="card_number" id="card_number"
																		class="form-control" placeholder="Card number"
																		value="<?php echo $rsedit['card_number']; ?>">
																</div>
															</div>

															<div class="w3_agileits_card_number_grid_left">
																<div class="controls">
																	<label class="control-label">CVV number <span
																			class="errormsg"
																			id="errcvv_number"></span></label>
																	<input name="cvv_number" id="cvv_number"
																		class="form-control" placeholder="CVV number"
																		value="<?php echo $rsedit['cvv_number']; ?>">
																</div>
															</div>
															<div class="w3_agileits_card_number_grid_left">
																<div class="controls">
																	<label class="control-label">Card Expiry date <span
																			class="errormsg"
																			id="errexpire_date"></span></label>
																	<input name="expire_date" id="expire_date"
																		type="month" class="form-control"
																		placeholder="expire date"
																		value="<?php echo $rsedit['expire_date']; ?>"
																		min="<?php echo date("Y-m"); ?>">
																</div>
															</div>

															<button class="btn btn-info" type="submit"
																name="submit">Click here to make payment</button>
														</div>
											</section>
										</form>
