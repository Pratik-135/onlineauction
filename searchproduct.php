...
<br><h3><?php echo $_GET['auctiontype'];?></h3><hr>
		...
		if($_GET['searchcategory_id'] != "")
		{
			...
			{
			$sqlcategory = $sqlcategory . " AND category_id='" . $_GET['searchcategory_id'] . "'";
			}
		}
		...
		while($rscategory = mysqli_fetch_array($qsqlcategory))
		{
			...
			$sqlproduct = $sqlproduct . " AND product.category_id='" . $rscategory['category_id'] . "'";
			/*
			if($_GET['searchcategory_id'] != "")
			{
			$sqlproduct = $sqlproduct . " AND product.category_id='" . $_GET['searchcategory_id'] . "'";
			}
			*/
