                                    ...
                                    <div class="single-product-tab">
                                        <div class="zoomWrapper">
                                            <div id="img-1" class="zoomWrapper single-zoom">
                                                <a href="#">
                                                    <img id="zoom1" src="img/product/lg-product-1.jpg" data-zoom-image="img/product/lg-product-1.jpg" alt="big-1">
                                                </a>
                                            </div>
                                            <div class="single-zoom-thumb">
                                                <ul class="s-tab-zoom single-product-active owl-carousel" id="gallery_01">
                                                    <li>
                                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image="img/product/lg-product-1.jpg" data-zoom-image="img/product/lg-product-1.jpg"><img src="img/product/1.jpg" alt="zo-th-1"/></a>
                                                    </li>
                                                    <li class="">
                                                        <a href="#" class="elevatezoom-gallery" data-image="img/product/lg-product-2.jpg" data-zoom-image="img/product/lg-product-2.jpg"><img src="img/product/2.jpg" alt="zo-th-2"></a>
                                                    </li>
                                                    <li class="">
                                                        <a href="#" class="elevatezoom-gallery" data-image="img/product/lg-product-3.jpg" data-zoom-image="img/product/lg-product-3.jpg"><img src="img/product/3.jpg" alt="ex-big-3" /></a>
                                                    </li>
                                                    <li class="">
                                                        <a href="#" class="elevatezoom-gallery" data-image="img/product/lg-product-4.jpg" data-zoom-image="img/product/lg-product-4.jpg"><img src="img/product/4.jpg" alt="zo-th-4"></a>
                                                    </li>
                                                    <li class="#">
                                                        <a href="#" class="elevatezoom-gallery" data-image="img/product/lg-product-5.jpg" data-zoom-image="img/product/lg-product-5.jpg"><img src="img/product/5.jpg" alt="zo-th-5"></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
