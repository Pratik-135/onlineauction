...
<select  name="state" id="state" class="form-control">
	...
	<option value="Pradesh No.1 ">Pradesh No.1 </option>
	<option value="Pradesh No.1 ">Pradesh No.2 </option>
	<option value="Pradesh No.1 ">Pradesh No.3 </option>
	<option value="Pradesh No.1 ">Pradesh No.4 </option>
	<option value="Pradesh No.1 ">Pradesh No.5 </option>
	<option value="Pradesh No.1 ">Pradesh No.6 </option>
	<option value="Pradesh No.1 ">Pradesh No.7 </option>
