			...
			<div class="col-md-12 agileinfo_single_right">
				...
				<div class="snipcart-item block">
					<div class="w3agile_description">
						<div id="printableArea">
							<table id="datatable" class="table table-striped table-bordered dataTable" cellspacing="0"
								...
								<tr>
									...
									<td><b>Date:</b>
										<?php echo $rspayment['purchase_date']; ?>
									</td>
								</tr>
								<tr>
									<td><b>Customer</b>
						...
						<hr>
						<center><input type="button" name='print' class="btn btn-primary"
								onclick="printDiv('printableArea')" value="Click here to Print"></center>
						<br>
						<hr>
					</div>
				</div>
