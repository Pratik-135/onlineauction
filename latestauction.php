...
while($rscategory = mysqli_fetch_array($qsqlcategory)) {
    $sqlproduct = "select * from product WHERE status='Active' AND category_id='$rscategory[category_id]'  AND start_date_time<='$dttim'  AND product.customer_id!='0' ";
			...
			<figure class="card card-product">
					...
					<center>
						<a
							href="single.php?productid=<?php echo $rsproduct[0]; ?>"><img
								...
								class="img-responsive" style="height: 250px; object-fit:center;" /></a>
					</center>
				</div>
				...
				<div class="bottom-wrap d-flex justify-content-center">
					<a href="single.php?productid=<?php echo $rsproduct['product_id']; ?>"
						class="btn btn-sm btn-primary float-right px-10" style="border-radius:20px; width:80px">Bid
						now</a>
					<!-- price-wrap.// -->
				</div> <!-- bottom-wrap.// -->
			</figure>
