...
if(isset($_POST['btncustlogin'])) {
    $nepal=md5($_POST['password']);
    
    $sql ="SELECT * FROM customer WHERE (email_id='$_POST[email]' || mobile_no='$_POST[email]') AND password='$nepal' AND status='Active'";
				...
				<div class="customer-login-register">
					...
					<div class="login-Register-info">
						<form action="" method="post" action="" onsubmit="return validatecustomer()">
							...
							<div class="clear"></div>
							<p>
								<button value="Login" name="btncustlogin" class="button-login"
