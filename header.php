...
<body>
	...
	<div class="wrapper home-3">
		...
		<header>
			...
			<div>
				<div class="container-fluid" style="background-color:#21232b; align-items: center">
					<div class="row">
						<div class="col-lg-12 d-flex p-0 m-0 d-flex align-items-center" style="height:100px">
							<div class="col-lg-2 ">
								<a href="index.php">
									<img src="images/auctionpng2.png" />
								</a>
							</div>
...
while($rscategory = mysqli_fetch_array($qsqlcategory)) {
    if($rscategory['category_id'] == $_GET['searchcategory_id']) {
...
?>
											...
											<input type="text" name="searchcriteria" placeholder="Search products... "
												value="<?php echo $_GET['searchcriteria']; ?>">
							...
							<div class="col-lg-2 ">
								...
								<div class="d-flex align-items-center text-white justify-content-end"
									style="color:#FFFFFF">
									<img src="images/wallet.png" style="height: 30px;width:30px;" />
     ...
     if(isset($_SESSION['customer_id'])) {
         ?>
										...
										<li>
											<a href="deposit.php">
												<span class="item-cart-inner text-white" style="font-weight: bold">
													Balance
												</span>
												<div class="item-total text-white" style="font-size:13px">
													NPR
													<?php echo $accbalamt; ?>
												</div>
											</a>
         ...
         ?>
										<li>
											<a href="customerlogin.php" class="d-flex align-items-center">
												<span class="item-cart-inner text-white">
													Deposit
												</span>
							...
							<!-- <div class="main-menu-area">
								...
								<nav>
									...
									<ul>
										...
										<li><a href="latestauction.php?auctiontype=Latest Auctions">Latest Auctions</a>
										</li>
										<li><a href="featured.php?auctiontype=featured Auctions">Featured Auctions</a>
										</li>
										<li><a href="upcominauction.php?auctiontype=Upcoming Auctions">Upcoming
												Auctions</a></li>
										<li><a href="closingauctions.php?auctiontype=Closing Auctions"
...
?>
    ...
    if(isset($_SESSION['customer_id'])) {
        ?>
													...
													<li class="drodown-show"><a href="#"> View My Bid <i
        ...
        ?>)</a></li>
															...
															<li><a href="viewbillingcustomer.php">View Trasaction</a>
															</li>
														</ul>
													</li>
													<li class="drodown-show"><a href="#"> My Products <i
																class="fa fa-angle-down"></i></a>
														<ul class="open-dropdown setting">
													...
													<li class="drodown-show"><a href="#"> My account <i
														...
														<ul class="open-dropdown setting">
															...
															<li><a href="custchangepassword.php">Change password</a>
															</li>
        ...
        ?>
													...
													<li class="drodown-show"><a href="#"> Reverse Product <i
																class="fa fa-angle-down"></i></a>
														<ul class="open-dropdown setting">
															<li><a href="selectreversebidcategory.php">Add Product</a>
															</li>
        ...
        if($_SESSION['employee_type'] == "Admin") {
            ?>
													<li class="drodown-show"><a href="#"> Auction Settings <i
																class="fa fa-angle-down"></i></a>
														<ul class="open-dropdown setting">
        ...
        ?>
													<li class="drodown-show"><a href="#"> Bidding Report <i
																class="fa fa-angle-down"></i></a>
														<ul class="open-dropdown setting">
															<li><a href="viewbiddingproduct.php">Current Bidding</a>
															</li>
															<li><a href="closebiddingproduct.php">Closed Bidding</a>
															</li>
								...
								<!-- <div class="main-menu-area">
									...
									<nav>
										...
										<ul>
											...
											<li><a href="latestauction.php?auctiontype=Latest Auctions"
													style="color: black;">Latest Auctions</a></li>
											<li><a href="featured.php?auctiontype=featured Auctions"
													style="color: black;">Featured Auctions</a></li>
											<li><a href="upcominauction.php?auctiontype=Upcoming Auctions"
													style="color: black;">Upcoming Auctions</a></li>
											<li><a href="closingauctions.php?auctiontype=Closing Auctions"
													style="color: black;">Closing Auctions</a></li>
											<li><a href="closed.php?auctiontype=Closed Auctions"
													style="color: black;">Closed Auctions</a></li>
											<li><a href="displayreversebid.php" style="color: black;">Reverse Bid</a>
											</li>
    ...
    ?>
		...
		<div class="slider-main-area">
			<div class="slider-active owl-carousel">
				...
				<div class="slider-wrapper" style="background-image:url(img/slider/2.jpg);width: 100%;">
					<div class="container-fluid">
						<div class="row">
							<div class="col">
								<div class="slider-text-info style-2 text-center slider-text-animation">
									<h1 class="title1"><span class="text">AuctionAxis..</span></h1>
									<p>Nepals's top rated auction platform..</p>
									<div class="slier-btn-1">
										<a title="Bid now" href="latestauction.php?auctiontype=Latest%20Auctions"
				...
				<!-- slider-wrapper end -->
				<!-- slider-wrapper start -->
				<div class="slider-wrapper" style="background-image:url(img/slider/3.jpg);width: 100%;">
					<div class="container-fluid">
						<div class="row">
							<div class="col">
								<div class="slider-text-info style-2 text-center slider-text-animation">
									<h1 class="title1"><span class="text">AuctionAxis.. </span> </h1>
									<p>Nepal's top rated auction platform..</p>
									<div class="slier-btn-1">
										<a title="Bid now" href="featured.php?auctiontype=featured%20Auctions"
						...
						<div class="row">
							<div class="col">
								<div class="slider-text-info style-2 text-center slider-text-animation">
									...
									<p>Nepal's top rated auction platform..</p>
									<div class="slier-btn-1">
										<a title="Bid now" href="upcominauction.php?auctiontype=Upcoming%20Auctions"
