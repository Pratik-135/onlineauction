                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 md-custom-12">
                                <!-- logo start -->
                                <div class="logo">
                                    <a href="index.php"><img class="logomanage" src="../logo2.png" alt=""></a>
                                </div>
                                <!-- logo end -->
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>977-9810781885 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
...
<select id="searchcategory_id" name="searchcategory_id" class="nice-select">
	...
	?>
		...
		<input type="text" name="searchcriteria" placeholder="Enter your search key ... " value="<?php echo $_GET['searchcriteria']; ?>">
...
<div class="item-total">NPR<?php echo $accbalamt; ?></div>
</a>
</li>
<?php
}
