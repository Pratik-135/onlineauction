...
<div class="container">
    ...
    <div class="row">
<?php
//$sqlunique = "SELECT MIN(t1.bidding_amount) AS price, t1.product_id FROM ( SELECT `bidding_amount`, product_id FROM bidding WHERE bidding.customer_id='" . $_SESSION['customer_id'] . "' GROUP BY `bidding_amount`, product_id HAVING COUNT(`bidding_amount`) = 1) t1";
