...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$sql = "INSERT INTO employee(employee_name,login_id,password,employee_type,status) VALUES('$_POST[employee_name]','$_POST[login_id]','$nepal','$_POST[employee_type]','$_POST[status]')";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) == 1)
		{
