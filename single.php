				...
				<div class="card mb-10">
					<div class="card-header">
						<nav class="header-navigation">
							...
							<ol class="breadcrumb">
								<li class="breadcrumb-item active" onclick="window.location='index.php'"
                  ...
                  for($iimg = 0; count((array)$arr_product_image) > $iimg; $iimg++) {
                      ?>
										<li><img src="imgproduct/<?php echo $arr_product_image[$iimg]; ?>"
												alt=""></li>
										<?php
                  }
?>
								...
								<div class="product-gallery-featured">
									<img src="imgproduct/<?php echo $arr_product_image[0]; ?>"
										alt="">
								</div>
							</div>
...
?>
															<li><a href="#review" data-toggle="tab">Bidders list
																	(<?php echo mysqli_num_rows($qsqledit); ?>)</a>
															</li>
														</ul>
													</div>
												</div>
													...
													<div class="tab-content">
														<div class="tab-pane fade in active show" id="description">
															<div class="description-content">
																	...
																	<div class="col-lg-12 col-md-8">
																		<table
																			...
																			<tbody>
																				<tr>
																					<th>Uploaded by :</th>
																					<td><?php echo $rsproduct['customer_name']; ?>
																					</td>
																				</tr>
																				<tr>
																					<th>Product Code :</th>
																					<td><?php echo $rsproduct['product_id']; ?>
																					</td>
																				</tr>
																				<tr>
																					<th>Product warranty :</th>
																					<td><?php echo $rsproduct['product_warranty']; ?>
																					</td>
																				</tr>
																				<tr>
																					<th>Company :</th>
																					<td><?php echo $rsproduct['company_name']; ?>
																					</td>
																				</tr>
																			</tbody>
																		</table>
																...
																<div class="row">
																	<div class="col-md-12">
																		<p><?php echo $rsproduct['product_description']; ?>
																		</p>
																	</div>
																</div>
																<hr>
																<div class="row">
																	<div class="col-md-12">
																		<p><b>Product Delivery details :</b>
																			<?php echo $rsproduct['product_delivery']; ?>
																		</p>
																	</div>
																</div>
																<hr>
...
while($rsedit= mysqli_fetch_array($qsqleditbidding)) {
    echo "$rsedit[customer_name] bidded NPR". $rsedit['bidding_amount'] ." on $rsedit[bidding_date_time]<hr>";
}
?>
																</p>
															</div>
						...
						<div class="product-payment-details">
							...
							<div>
								<h2><?php echo $rsproduct['product_name']; ?>
								</h2>
								<div class="rating-box">
									<ul class="rating">
										<li><i
												class="fa fa-star"><b><?php echo $rsproduct['category_name']; ?></b></i>
										</li>
									</ul>
								</div>
								<p>
								<h5>Time Remaining<p
										id="demo<?php $rsproduct['product_id']; ?>"
										style="color: red;"></p>
									</h4>
									<script>
										// Set the date we're counting down to
										var countDownDate = new Date(
											"<?php echo date("M d, Y H:i:s", strtotime($rsproduct[8])); ?>"
										).getTime();
										...
										var x = setInterval(function() {
											...
											if (distance < 0) {
												...
												document.getElementById(
													"demo<?php $rsproduct['product_id']; ?>"
												).innerHTML = "EXPIRED";

												document.getElementById("divbidstatus").innerHTML =
													'<div class="snipcart-details agileinfo_single_right_details"><input type="button" name="submit" value="Closed" class="button" disabled /></div>';
										...
										function countdowntimer(id, time) {
											...
											var x = setInterval(function() {
												...
												document.getElementById("countdowntime" + id).innerHTML =
													"<b  style='color: red;'>Time Remaining</b> <br><b>" + days + "Days " + hours + "hrs " +
									...
									<div class="price-box">
										<p><b>Actual product cost</b> : NPR
											<?php echo $rsproduct['product_cost']; ?>
										</p>
										<h4>Current Bid Amount : <br>NPR
											<?php echo $rsproduct['ending_bid']; ?>
										</h4>

										<input type='hidden' name='max_bid_amt' id='max_bid_amt'
											value='<?php echo $rsproduct['ending_bid']+150; ?>'>
										...
										<form action="" method="post" onsubmit="return confirmbidding()">
											<input type='hidden' name='ending_bid' id='ending_bid'
												value='<?php echo $rsproduct['ending_bid']; ?>'>
											<?php
    ...
    if($endtime >$currenttime) {
												...
												<div class="w3_agileits_card_number_grid_left">
													<div class="controls">
														...
														<input name="purchase_amount" id="purchase_amount"
															class="form-control" type="text" placeholder="Enter amount"
        ...
        ?>
											<fieldset>
												...
												<div class="snipcart-details agileinfo_single_right_details">
													<a
														href='single.php?productid=<?php echo $rsproduct['product_id']; ?>'><input
		...
		<div class="row">
			<div class="col">
				<div class="section-title-3">
					<h2>Similar products under
						<?php echo $rsproduct['category_name']; ?>:
					</h2>
				</div>
			</div>
		</div>
...
while($rsproduct = mysqli_fetch_array($qsqlproduct)) {
    ...
    } elseif (file_exists("imgproduct/".$arrproimg[0])) {
				...
				<div class="col">
					...
					<div class="single-product-wrap">
						<div class="product-image box" style="height:350px;width:100%;">
							<a
								href="single.php?productid=<?php echo $rsproduct[0]; ?>">
								<div id="img-1" class="zoomWrapper single-zoom" style="background-color: #f8f8f8;">
									<a
										href="single.php?productid=<?php echo $rsproduct[0]; ?>">
										<center><img id="zoom1"
												src="<?php echo $imgname; ?>"
												data-zoom-image="<?php echo $imgname; ?>"
...
<script>
	function confirmbidding() {
		...
		if (parseFloat(document.getElementById("ending_bid").value) > parseFloat(document.getElementById("purchase_amount")
				.value)) {
			alert('Bidding amount must be greater than NPR' + document.getElementById("ending_bid").value);
			return false;
		} else if (parseFloat(document.getElementById("purchase_amount").value) > parseFloat(document.getElementById(
				"max_bid_amt").value)) {
			alert('Bidding amount should be lesser than NPR' + document.getElementById("max_bid_amt").value);
			return false;
		} else {
