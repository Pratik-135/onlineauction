...
function countdowntimer(id, time)
{
		...
		if (distance < 0) {
			...
			document.getElementById("countdowntime"+id).innerHTML = "<center><b  style='color: red;'>EXPIRED</b></center>";
                                            ...
                                            <div class="price-box">
<p><b>Actual product cost</b> : NPR <?php echo $rsproduct['product_cost']; ?></p> <h4>Current Bid Amount : <br>NPR <?php echo $rsproduct['ending_bid']; ?></h4>

<input type='hidden' name='max_bid_amt' id='max_bid_amt' value='<?php echo $rsproduct['ending_bid']+150; ?>'>
