...
if(isset($_POST['submit']))
{
	...
	$owneremailid="vijaybadhur760@gmail.com";
	$title = "Enquiry Mail";
	$msg = "
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address : Online Auction, Tinkune kathmandu Nepal</li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i> +977-9810781885</li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp;vijaybadhur760@gmail.com</li>
                                </ul>
                            </div>
                        </div>
