										...
										<div class="w3agile_description">
											<div id="printableArea">
												<table id="datatable"
													...
													<tr>
														<th colspan="3">
															<center>Auction Axis Hub</center>
														</th>
													</tr>
													<tr>
														<td colspan="3">
															<center>kathmandu Nepal</center>
														</td>
													</tr>
													<tr>
														<td><b>Bill No.</b>
															<?php echo $rspayment['billing_id']; ?>
														</td>
														<td><b>Date</b>
															<?php echo date("d-M-Y", strtotime($rspayment['purchase_date'])); ?>
														</td>
													</tr>
													<tr>
														<td><b>Customer</b>
														...
														<td><b>Payment type</b>
															<?php echo $rspayment['card_type']; ?>
														</td>
													</tr>
													<tr>
														<td><b>Product name</b> </td>
														<td><?php echo $rspayment['product_name']; ?>
														</td>
													</tr>
													<tr>
														<th><b>Paid amount</b></th>
														<td>Rs.
															<?php echo $rspayment['purchase_amount']; ?>
														</td>
													</tr>
												</table>
											</div>
											<hr>
											<center><input type="button" class="btn btn-info" name='print'
													onclick="printDiv('printableArea')" value="Click here to Print">
											</center>
											<br>
										</div>
									</div>
