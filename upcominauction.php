...
<br><h3><?php echo ucfirst($_GET['auctiontype']);?></h3><hr>
		<?php
...
<div class="label-rating"><span>Starts on <?php echo date("d-M-Y h:i A",strtotime($rsproduct['start_date_time']));?></span><br></div>
				</div> <!-- rating-wrap.// -->
		</figcaption>
		<div class="bottom-wrap">
				...
				<div class="price-wrap h5">
					<span class="price-new">Starting bid : NPR <?php echo $rsproduct['starting_bid']; ?></span> 
