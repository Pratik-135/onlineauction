...
for($iimg = 0; $iimg <count((array)$arr_pro_img); $iimg++) {
    ?>
							<img class="mySlides<?php echo $rs[0]; ?> w3-animate-fading"
								src="imgproduct/<?php echo $arr_pro_img[$iimg]; ?>"
								style="width:100%">
							<?php
}
    ?>
