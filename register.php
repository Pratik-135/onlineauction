...
{   
	$sql ="INSERT INTO customer(customer_name,email_id,password,mobile_no,status) values('$_POST[customer_name]','$_POST[email_id]',md5('$_POST[password]'),'$_POST[mobile_no]','Active')";
...
<form action="" method="post"> 
	...
	<p class="coupon-input form-row-first">
		...
		<input type="text" name="mobile_no" id="mobile_no" value="+977" onkeypress="return isNumber(event)" >
	</p>
   ...
   <div class="clear"></div>
	<p>
		<button value="Login" name="btnsubmit" id="btnsubmit" class="button-login" type="Submit"onclick="return validatecustomer()" >Register</button>
...
function validatecustomer()
{
	...
	*/
	...
	if(document.getElementById("mobile_no").value.length != 14)
	{
