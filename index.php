...
<div class="product-area pb-95 pt-40">
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="row">
    ...
    ?>
										<div class="col">
											...
											<div class="single-product-wrap">
												<div class="product-image box" style="width:100%;">
													<a
														href="single.php?productid=<?php echo $rsproduct[0]; ?>">
														<img class="primary-image"
															src="<?php echo $imgname; ?>"
															alt="" style="width:100%; height:240px; object-fit:cover;">
												...
												<div class="product_desc">
													<div class="product_desc_info">
														...
														<div class="manufacturer"><a
																href="single.php?productid=<?php echo $rsproduct[0]; ?>">Product
																Code:
																<?php echo $rsproduct['product_id']; ?></a>
														</div>
														<!-- Timer code starts here -->
														<?php /* <p id="countdowntime<?php echo $rsproduct[0].$i; ?>">abc</p> */ ?>
														<script type="application/javascript">
															countdowntimer('<?php echo $rsproduct[0].$i; ?>',
...
*/
    ?>
														...
														<!-- Timer code starts here -->
														<p
															id="countdowntime<?php echo $rsproduct[0].$i; ?>">
														</p>
														<script type="application/javascript">
															countdowntimer('<?php echo $rsproduct[0].$i; ?>',
																'<?php echo date("M d, Y H:i:s", strtotime($rsproduct['end_date_time'])); ?>'
